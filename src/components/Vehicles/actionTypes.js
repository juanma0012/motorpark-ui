...
export const ASK_REMOVE_VEHICLE = 'vehicles/ASK_REMOVE_VEHICLE';
export const REMOVED_VEHICLE = 'vehicles/REMOVED_VEHICLE';
export const REQUEST_REMOVE_VEHICLE = 'vehicles/REQUEST_REMOVE_VEHICLE';
